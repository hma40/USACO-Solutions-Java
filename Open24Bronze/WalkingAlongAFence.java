...
public class WalkingAlongAFence {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0; i < p; i++) {
            Point temp = new Point(io.nextLong(), io.nextLong());
            allPoints.add(temp);
            all.add(temp.x);
            all.add(temp.y);
        }
        ...
        for(TwoPoints tp: cows) {
            ...
            if(temp1==temp3) {
                ...
                //System.out.println(prefSum[temp2.index]+" "+prefSum[temp1.index]+" "+temp0.index+" "+temp1.index+" "+temp2.index+" "+temp3.index);
                oneDir=pointDist(tp.a, temp1)+prefSum[temp2.index]-prefSum[temp1.index]+pointDist(temp2,tp.b);
            } else {
                //System.out.println("case 2");
                //System.out.println(prefSum[temp0.index]+" "+prefSum[temp3.index]+" "+temp0.index+" "+temp1.index+" "+temp2.index+" "+temp3.index);
                oneDir=pointDist(tp.b, temp3)+prefSum[temp0.index]-prefSum[temp3.index]+pointDist(temp0, tp.a);
            }
            //System.out.println(tp+" "+temp0+" "+temp1+" "+temp2+" "+temp3+" "+oneDir);
            //System.out.println(oneDir+" "+prefSum[p]);
            io.append(Math.min(oneDir, prefSum[p]-oneDir));
        }
        io.printAns();
    }
